REM   Script: DDL & DML Bioskop
REM   DBMS mata kuliah Pemodelan dan Implementasi Basis Data.
...
/* DML: ALL COMMANDS */
/* STUDI KASUS MODUL 4 */
UPDATE Member_1303194010 set no_hp='08098933333' where id_memer='MM0113';
UPDATE Member_1303194010 set email='doni_inod@gmail.com' where id_memer='MM0117';
UPDATE Theater_1303194010 set harga='100000' where id_theater='Theater 5';
DELETE FROM Film_1303194010 where id_film='F0104';
DELETE FROM Theater_1303194010 where id_theater='Theater 3';

/* TES AKHIR MOD 4 */
create table Mahasiswa_1303194010 (
    nim int,
...
INSERT INTO Mahasiswa_1303194010 values ('1303190101', 'Tommy', 'Shelby', 'IT-43-05', 'Steven Knight');
INSERT INTO Mahasiswa_1303194010 values ('1303190101', 'Arthur', 'Shelby', 'IT-43-05', 'Steven Knight');
INSERT INTO Mahasiswa_1303194010 values ('1303190101', 'John', 'Shelby', 'IT-43-05', 'Steven Knight');
INSERT INTO Mahasiswa_1303194010 values ('1303190101', 'Grace', 'Shelby', 'IT-43-05', 'David Caffrey');
INSERT INTO Mahasiswa_1303194010 values ('1303190101', 'Linda', 'Shelby', 'IT-43-05', 'David Caffrey');
...
/* SOAL YANG SESUNGGUHNYA */
/* Nomor 1 */
/* CONCAT EXTRACT DAY, NATURAL JOIN, WHERE BETWEEN */
SELECT judul, id_teater, periode_start,
CONCAT(EXTRACT(DAY FROM periode_end), ' hari') "LAMA WAKTU"
FROM film_1303194010
NATURAL JOIN jadwal_1303194010
WHERE ('01-JUL-2019' BETWEEN periode_start AND periode_end)
AND judul = 'Habibie Ainun 3';

/* Nomor 2 */
/* CASE CONDITION, NATURAL JOIN */
SELECT id_teater, judul, periode_start, kelas, harga,
CASE 
    WHEN harga < 50000 THEN 'Murah'
    WHEN harga > 75000 THEN 'Mahal'
    ELSE 'Normal'
    END AS "KATEGORI"
FROM film_1303194010
NATURAL JOIN jadwal_1303194010
...
/* Nomor 3 */
/* CASE CONDITION, NATURAL JOIN, ORDER BY */
SELECT id_member, harga, TRUNC(MONTHS_BETWEEN(SYSDATE, tgl_lahir)/12) UMUR,
CASE
    WHEN TRUNC(MONTHS_BETWEEN(SYSDATE, tgl_lahir)/12) <= 32 THEN (harga * 0.10)
    ELSE harga
    END AS SALE
FROM member_1303194010
NATURAL JOIN transaksi_1303194010
...
/* Nomor 4 */
/* NATURAL JOIN, WHERE CONDITION, LIKE, ORDER BY */
SELECT id_member, nama_member, judul
FROM transaksi_1303194010
...
/* Tes Akhir MOD 9 */
CREATE VIEW informasi_teater AS
